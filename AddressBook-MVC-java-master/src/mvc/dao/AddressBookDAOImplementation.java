    ...
    {   
       try
       {
          conn = DBConnection.getInstance().getConnect();
           ...
           qry = "insert into AddressBook values ('"+person.getName()+"','"+person.getMob()+"','"+person.getEmail()+"','"+person.getAddress()+"','"+person.getCity()+"')";
    ...
    @Override
     ...
     public void updatePerson(Person person,String name)
     {
         try
       {
           conn = DBConnection.getInstance().getConnect();
           st = conn.createStatement();
            String qry="update AddressBook set name='"+person.getName()+"',mob='"+person.getMob()+"',email='"+person.getEmail()+"',address='"+person.getAddress()+"',city='"+person.getCity()+"' where name='"+name+"'";
